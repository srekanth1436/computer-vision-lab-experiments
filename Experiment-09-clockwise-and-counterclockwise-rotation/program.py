...
save_image(OUTPUT_DIR / "clockwise.png", clockwise)
save_image(OUTPUT_DIR / "counterclockwise.png", counterclockwise)
print("Saved clockwise.png and counterclockwise.png")
